...
import com.graduate.service.ReplyService3;
...
public class ReplyController3 {
	...
	public ResponseEntity<String> register(@RequestBody ReplyVO3 vo){
		//뭐하며 ㄴ에러남
	...
	public ResponseEntity<List<ReplyVO3>> list(
			@PathVariable("bno") Integer bno)
	{
		ResponseEntity<List<ReplyVO3>> entity=null;
		try {
	...
	public ResponseEntity<Map<String,Object>> listPage(
		...
		try {
			...
			List<ReplyVO3> list = service.listReplyPage(bno, cri);
