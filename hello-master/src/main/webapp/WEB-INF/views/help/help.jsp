...
<script type="text/javascript">
if("${id}"=="forteas2"){
document.write("<button id='newBtn' class='btn btn-primary'>글 쓰기</button>");
}
</script>	
</div>
...
<table class="table table-bordered">
   ...
   <tbody>
    <c:forEach items="${list7}" var="boardVO" >
		<tr>
			<td>${boardVO.bno}</td>
			<td><a href='/help/readPage${pageMaker.makeSearch(pageMaker.cri.page)}&bno=${boardVO.bno}&title=${boardVO.title}'>${boardVO.title}
...
${".pagination li a"}.on("click",function(event){
	...
	jobForm.attr("action","/help/list").attr("method","get");
	jobForm.submit();
