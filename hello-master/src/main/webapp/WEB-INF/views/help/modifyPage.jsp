...
<form role="form" method="post" action="modifyPage">
	...
	<div class="box-body">
		...
		<div class="form-group">
			...
			name="bno" class="form-control" value="${boardVO4.bno }" readonly="readonly">
		</div>
		<div class="form-group">
			<label for="exampleInputEmail1">제목</label><input type="text" name="title"
			class="form-control" value="${boardVO4.title }">
		</div>
		<div class="form-group">
			<label for="exampleInputPassword1">내용</label>
			<textarea class="form-control" name="content" rows="3">${boardVO4.content}</textarea>
		</div>
		<div class="form-group">
			<label for="exampleInputEmail1">글쓴이</label><input
			type="text" name="writer" class="form-control" value="${boardVO4.writer}">
		</div>
	...
	<div class="box-footer" style="width:1500px; margin:auto;">
		<div>
			<hr>
		</div>
...
$(document).ready(function(){
	...
	$(".btn-warning").on("click", function(){
	  self.location = "/help/?page=${cri.page}&perPageNum=${cri.perPageNum}"+
