...
.btn-primary{background-color:#9370DB;}
</style>
<script type="text/javascript">
var name="${name}";
...
<div class="box-body" style="margin-left:355px; margin-top:40px;">
...
<table class="table table-bordered" >
   ...
   <tbody>
    <c:forEach items="${list4}" var="boardVO">
		<tr>
			<td>${boardVO.bno}</td>
			<td><a href='/food/readPage${pageMaker.makeSearch(pageMaker.cri.page)}&bno=${boardVO.bno}&title=${boardVO.title}'>${boardVO.title}
...
${".pagination li a"}.on("click",function(event){
	...
	jobForm.attr("action","/food/list").attr("method","get");
	jobForm.submit();
